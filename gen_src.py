#!/usr/bin/env python3
"""Generate the complete lib.rs for lau-audio."""
import pathlib

def main():
    out = pathlib.Path("/tmp/lau-audio/src/lib.rs")

    # Part 1: All the library code (no tests)
    lib = r"""//! `lau-audio` — procedural audio generation for games.
//!
...
"""
    ...
    print(f"Wrote {len(full)} bytes to {out}")
